...
// converting plain object into tree object -> sorting date/invoice
let myDb = {};
db.forEach(element => {
...
function toggleDayVisibilityStatus(event) {
	if (event.target.classList.contains("daycard__date")) {
...
function toggleQuantityVisibility(event) {
	if (event.target.classList.contains("goods-quantity")) {
...
let dayCardDate = document.getElementsByClassName("daycard__date");
...
let goodsQuantityOpener = document.getElementsByClassName("goods-quantity");
